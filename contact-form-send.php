...
if($_POST)
{
    $to_email = "reservas@hotelbristol.com.ar"; //Recipient email, Replace with own email here
    ...
    $send_mail = mail($to_email, "Hotel Bristol - Formulario de contacto", $msg_body, $headers);
